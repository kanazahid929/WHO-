            ...
            return async function () {  
                ...
                if (dataAddedParticipants.some((item) => item.userFbId == api.getCurrentUserID())) {  
                    ...
                    return message.send({
                        ...
                        attachment: await global.utils.getStreamFromUrl("https://files.catbox.moe/yx8c5i.mp4", {
                            headers: {
                                "User-Agent": "Mozilla/5.0 (GoatBot Welcome Module)"
                            }
                        })
                    });
                }  
                ...
                global.temp.welcomeEvent[threadID].joinTimeout = setTimeout(async function () {  
                    ...
                    if (threadData.data.welcomeAttachment) {  
                        ...
                        form.attachment = await global.utils.getStreamFromUrl("https://files.catbox.moe/yx8c5i.mp4", {
                            headers: {
                                "User-Agent": "Mozilla/5.0 (GoatBot Welcome Module)"
                            }
                        });
